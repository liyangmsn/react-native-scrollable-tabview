...
class ScrollableTabView extends Component {
  ...
  render() {
    ...
    if (this.props.styles) {
        if (this.props.styles.topTabBarStyle) {
            tabBarProps.style = this.props.styles.topTabBarStyle
        }
        if (this.props.styles.tabBarActiveTextStyle) {
            tabBarProps.tabBarActiveTextStyle = this.props.styles.tabBarActiveTextStyle
        }
        if (this.props.styles.tabBarInactiveTextColor) {
            tabBarProps.tabBarInactiveTextColor = this.props.styles.tabBarInactiveTextColor
        }
        if (this.props.styles.tabStyle) {
            tabBarProps.tabStyle = this.props.styles.tabStyle
        }
    }
    if (overlayTabs) {
      tabBarProps.style = {
